...
\title{Visual Data Science - Discover Report}
...
The focus of this project is to visualize and analyze global electricity production and its composition over time.
...
The project aims to highlight trends, shifts, and milestones in the global energy landscape, linking them to broader sustainability goals.
...
Through these visualizations, the project seeks to provide clear insights into how the global electricity mix is changing and how this affects CO\textsubscript{2} emissions and climate objectives.

\section{Dataset Description}

The dataset used for this project originates from the \textbf{Energy Institute Statistical Review of World Energy}
